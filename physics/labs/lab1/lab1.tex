...
\equationboxx{Laboratory Etiquette}{
\begin{itemize}
    \item Students may work in groups of 2-3. Make sure to include all group members--- collaboration is key!
    \item Students should have the same data as their group members, but responses to Pre-lab Questions and Analysis Questions must be unique between all members. 
    \item Students between different labs groups should have unique datasets, \textit{i.e.}, the sharing of data between groups is not permitted. 
    \item In the event of a lost lab packet, additional copies are available for download on Schoology or Google Classroom. 
\end{itemize}}
